...
/** Google's mark, the one piece of colour DESIGN.md allows on the sign-in screens —
 *  it is branded and may not be redrawn in ink. Shared, because both apps sign in. */
