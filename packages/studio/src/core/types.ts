...
export interface Timeline {
  ...
  blocks: Block[];
  /**
   * The frame range this state plays inside its animation, when that animation holds
   * several poses. Set on import so a `.lottie` whose states are segments of one strip
