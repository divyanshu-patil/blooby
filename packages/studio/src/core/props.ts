...
export const PROPS: Record<string, PropSpec> = {
  ...
  'limb.hose': { on: 'node', label: 'Rubber hose', range: [0, 1, 0.01, ''],
    help: 'Limbs only. 1 is a smooth, bendy rubber-hose limb; 0 is a rigid one of straight segments. In between blends the two.' },
  ...
  'limb.bend': { on: 'node', label: 'Bend', range: [-1, 1, 0.01, ''],
    help: 'Limbs only. How far the limb bows sideways off the straight line between its points. 0 is straight, ±0.4 a clear curve; the sign picks the side.' },
  ...
  'limb.length': { on: 'node', label: 'Length', range: [0.2, 2.5, 0.01, '×'],
    help: 'Limbs only. Stretches the reach from the shoulder. 1 is exactly to the points; 1.3 is a noticeably longer limb.' },
